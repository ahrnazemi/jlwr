...
function getProvincesInline() {
    ...
    var provSel = document.getElementById(provListId);
    if (typeof provSel != "undefined" && provSel != null) {
        country = document.getElementById(countryListId);
        ...
        try {
            ...
            for (var i = 0; i < fields.length; i++) {
                ...
                if ((required = validation.required) && this.arrayContains(required.fields, field)) {
                    ...
                    if (input.type == "select-one") { isError = (input.options[input.selectedIndex].value == ""); }

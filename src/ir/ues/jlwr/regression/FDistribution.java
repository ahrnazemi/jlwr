 ...
 * 
 * @see <a href="http://en.wikipedia.org/wiki/F-distribution">F-distribution
 *      (Wikipedia)</a>
 * @see <a
 *      href="http://mathworld.wolfram.com/F-Distribution.html">F-distribution
 *      (MathWorld)</a>
...
public class FDistribution extends AbstractRealDistribution {
	 ...
	 *             if {@code numeratorDegreesOfFreedom <= 0} or
	...
	/**
	 * Create an F distribution using the given degrees of freedom and inverse
	 * cumulative probability accuracy.
	 * 
	 * @param numeratorDegreesOfFreedom
	 *            Numerator degrees of freedom.
	 * @param denominatorDegreesOfFreedom

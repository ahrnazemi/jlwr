...
import ir.ues.jlwr.regression.MathArrays;
...
public class NonMonotonicSequenceException extends MathIllegalNumberException {
	...
	/**
	 * Construct the exception. This constructor uses default values assuming
	 * that the sequence should have been strictly increasing.
	 * 
	 * @param wrong
	 ...
	 */
	public NonMonotonicSequenceException(Number wrong, Number previous,
			int index) {
	 ...
	 *            Index of the value that did not match the requirements.
	 * @param direction
	 *            Strictly positive for a sequence required to be increasing,
	 *            negative (or zero) for a decreasing sequence.
	 * @param strict
	 *            Whether the sequence must be strictly increasing or
	 *            decreasing.
	 */
	public NonMonotonicSequenceException(Number wrong, Number previous,
			int index, MathArrays.OrderDirection direction, boolean strict) {
		super(
				direction == MathArrays.OrderDirection.INCREASING ? (strict ? LocalizedFormats.NOT_STRICTLY_INCREASING_SEQUENCE
						: LocalizedFormats.NOT_INCREASING_SEQUENCE)
						: (strict ? LocalizedFormats.NOT_STRICTLY_DECREASING_SEQUENCE

...
public abstract class BitsStreamGenerator implements RandomGenerator {
	 ...
	 * {@link #nextBoolean()}, {@link #nextBytes(byte[])}, {@link #nextDouble()}, {@link #nextFloat()}, {@link #nextGaussian()}, {@link #nextInt()},
	 ...
	 * with {@code next(31)} values rejected (i.e. regenerated) until a value
	 * that is larger than the remainder of {@code Integer.MAX_VALUE / n} is
	 * generated. Rejection of this initial segment is necessary to ensure a

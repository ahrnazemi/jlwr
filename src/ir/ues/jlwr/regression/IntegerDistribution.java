...
public interface IntegerDistribution {
	 ...
	 * @return the probability that a random variable with this distribution
	 *         will take a value between {@code x0} and {@code x1}, excluding
	 ...
	 * </ul>
	 * If the result exceeds the range of the data type {@code int}, then
	 ...
	 * </p>
	 * 
	 * @return lower bound of the support ({@code Integer.MIN_VALUE} for
	 *         negative infinity)
	 */
	 ...
	 * </p>
	 * 
	 * @return upper bound of the support ({@code Integer.MAX_VALUE} for
	 *         positive infinity)
	 */

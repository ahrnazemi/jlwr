...
public class Gamma {
	 ...
	 * > Confluent Hypergeometric Function of the First Kind</a>, equation (1).</li>
	 * </ul>
	 * 
	 * @param a
	 *            the a parameter.
	 ...
	 * @see <a
	 *      href="http://www.uv.es/~bernardo/1976AppStatist.pdf">Bernardo&apos;s
	 *      original article </a>
	 * @since 2.0
	 */
	public static double digamma(double x) {
		...
		if (x >= C_LIMIT) {
			...
			return FastMath.log(x) - 0.5 / x - inv

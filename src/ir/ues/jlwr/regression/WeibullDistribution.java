...
/**
 * Implementation of the Weibull distribution. This implementation uses the two
 * parameter form of the distribution defined by <a
...
public class WeibullDistribution extends AbstractRealDistribution {
	 ...
	 *            Maximum absolute error in inverse cumulative probability
	...
	public double density(double x) {
		...
		/*
		 * FastMath.pow(x / scale, shape) = FastMath.pow(xscale, shape) =
	 ...
	 * {@inheritDoc}
	 * 
	 * The variance is {@code scale^2 * Gamma(1 + (2 / shape)) - mean^2} where
